v1.3.2 07.11.25
+ Добавил флаг SEEDS_ENABLED в env конфиг #feature
+ Закрыл возможность создавать кастомные игры чтобы хакеры не роняли сервер

v1.3.1 27.07.25
+ Пофиксил уязвимость которая позволяла делать действия за любого игрока #bug
