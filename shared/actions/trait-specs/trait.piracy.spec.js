...
food: 0
players:
  - continent: $A piracy, $B piracy, $C piracy, $D piracy
  - continent: $A1 mass +, $B1 mass + fat=true, $C1 +, $D1 fat=true
`);
    ...
    expectUnchanged('$C cant steal $C (full)', () =>
        clientStore1.dispatch(traitActivateRequest('$C', 'TraitPiracy', '$C1'))
      , serverStore, clientStore0, clientStore1);
    expectUnchanged('$D cant steal $D1 (empty)', () =>
        clientStore1.dispatch(traitActivateRequest('$D', 'TraitPiracy', '$D1'))
      , serverStore, clientStore0, clientStore1);
