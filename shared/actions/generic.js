...
export const toUser$Client = (userId, action) => Object.assign(action, {meta: {clientOnly: true, userId}});

export const toUser$ClientServer = (userId, action) => Object.assign(action, {meta: {userId}});
