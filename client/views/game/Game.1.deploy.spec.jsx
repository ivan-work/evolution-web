...
//import * as cardData from '../../../shared/models/game/evolution/cardData';
//
...
//    , userId: 'User0'
//    , roomId: null
//    , deck: GameModel.generateDeck([[12, cardData.CardCarnivorous.type]])
//    , players: Map({
//      User0: new PlayerModel({
//        id: 'User0'
//        , hand: List([
//          CardModel.new(cardData.CardCarnivorous).set('id', 'card0')
//          , CardModel.new(cardData.CardCarnivorous).set('id', 'card1')
//          , CardModel.new(cardData.CardCarnivorous).set('id', 'card2')
//        ])
//        , index: 0
//      })
...
//          [2, cardData.CardCarnivorous]
//          , [2, cardData.CardCamouflage]
//          , [2, cardData.CardSharpVision]
//        ])
//        , index: 1
//      })
//    })
