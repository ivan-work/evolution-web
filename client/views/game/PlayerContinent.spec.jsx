...
describe('PlayerContinent', () => {
  ...
  it('One Card', () => {
    ...
    expect($PlayerContinent.find('DropTarget(PlayerContinentDropTargetZone)'), 'PlayerContinentDropTargetZone').length(2);
  });
  it('onOver animals 0 position 0', () => {
    const $PlayerContinent = shallow(<PlayerContinent>
    </PlayerContinent>);
    expect($PlayerContinent.find('.animals-container-inner').children(), 'child.length').length(0);
    expect($PlayerContinent.find('DropTarget(PlayerContinentDropTargetZone)'), 'PlayerContinentDropTargetZone').length(1);
